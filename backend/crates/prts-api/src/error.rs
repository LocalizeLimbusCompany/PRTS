...
fn status_for(code: &str) -> StatusCode {
    match code {
        ...
        | "AI_TIMEOUT_INVALID"
        | "AI_THINKING_BUDGET_INVALID"
        | "AI_REASONING_OPTIONS_INVALID"
        | "AI_CUSTOM_OPTIONS_INVALID"
        | "AI_CUSTOM_OPTIONS_CONFLICT"
        | "AI_CUSTOM_OPTIONS_SENSITIVE"
        | "WEB_SEARCH_OPTIONS_INVALID"
        ...
        | "API_KEY_SCOPES_REQUIRED"
        | "API_KEY_SCOPE_INVALID"
        | "API_KEY_ALL_SCOPE_EXCLUSIVE"
        | "API_KEY_SCOPE_NOT_AVAILABLE"
        | "API_KEY_NAME_INVALID"
        | "PROJECT_JOIN_POLICY_INVALID"
        | "PROJECT_JOIN_ROLE_INVALID"
        | "PROJECT_HISTORY_VISIBILITY_INVALID"
        | "PROJECT_JOIN_QUIZ_INVALID"
        | "PROJECT_JOIN_PASSWORD_REQUIRED"
        | "PROJECT_JOIN_SECRET_INVALID"
        | "PROJECT_JOIN_MESSAGE_INVALID"
        | "PROJECT_JOIN_CREDENTIAL_INVALID"
        | "PROJECT_MEMBER_QUERY_TOO_SHORT"
        | "PROJECT_HISTORY_CURSOR_INVALID"
        | "SEARCH_REGEX_TOO_LONG"
        ...
        "PROJECT_JOIN_APPLICATION_PENDING" | "PROJECT_ALREADY_MEMBER" => StatusCode::CONFLICT,
        "PROJECT_JOIN_RATE_LIMITED" => StatusCode::TOO_MANY_REQUESTS,
        "SEARCH_REGEX_TIMEOUT" => StatusCode::REQUEST_TIMEOUT,

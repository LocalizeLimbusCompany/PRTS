      ...
      <div className="max-w-6xl mx-auto space-y-3">
        ...
        {(isAdding || editingId) && (
          <div className="bg-white p-1.5 rounded-sm border border-slate-200 shadow-sm animate-in fade-in slide-in-from-top-4">
            <h2 className="text-lg font-semibold text-slate-900 mb-3">{editingId ? 'Edit Term' : 'Add New Term'}</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1 mb-3">
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-20 rounded-sm border border-slate-300 px-3 py-2 outline-none focus:border-blue-500 font-mono text-sm uppercase text-center"
                    placeholder="Lang"
                  />
                  <input
                    type="text"
                    ...
                    className="flex-1 rounded-sm border border-slate-300 px-2 py-2 outline-none focus:border-blue-500"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-sm border border-slate-300 px-2 py-1.5 outline-none focus:border-blue-500 min-h-[80px]"
        ...
        <div className="bg-white rounded-sm border border-slate-200 shadow-sm overflow-hidden">
          {isLoading ? (
            ...
            <div className="py-20 text-center text-slate-500">
              <BookA className="w-12 h-8 mx-auto mb-2 text-slate-300" />
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    <th className="px-3 py-2 font-semibold text-slate-900 w-1/3">Source Term</th>
                    <th className="px-3 py-2 font-semibold text-slate-900 w-1/3">Target Term</th>
                    <th className="px-3 py-2 font-semibold text-slate-900 w-auto">Notes</th>
                    ...
                    <tr key={term.id} className="hover:bg-slate-50/50 transition-colors">
                      <td className="px-3 py-2">
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm font-medium text-slate-900">{term.sourceTerm}</span>
                        </div>
                      </td>
                      <td className="px-3 py-2">
                        <div className="flex flex-col">
                          <span className="text-xs font-bold uppercase text-slate-400 mb-1 tracking-wider">{term.targetLanguage}</span>
                          <span className="text-sm font-medium text-blue-700">{term.targetTerm}</span>
                        </div>
                      </td>
                      <td className="px-3 py-2">

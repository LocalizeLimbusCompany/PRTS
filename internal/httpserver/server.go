...
func New(cfg config.Config, runtime *runtime.Runtime) *Server {
	...
	r.Route("/api/v1", func(api chi.Router) {
		...
		api.Post("/organizations", handlers.CreateOrganization(runtime.Store))
		api.Get("/organizations/{organizationId}", handlers.GetOrganization(runtime.Store))
		api.Patch("/organizations/{organizationId}", handlers.UpdateOrganization(runtime.Store))
		api.Get("/organizations/{organizationId}/projects", handlers.ListProjectsByOrganization(runtime.Store))
		api.Post("/organizations/{organizationId}/projects", handlers.CreateProject(runtime.Store))
		api.Get("/projects/{projectId}", handlers.GetProject(runtime.Store))
		api.Patch("/projects/{projectId}", handlers.UpdateProject(runtime.Store))
		api.Get("/projects/{projectId}/members", handlers.ListProjectMembers(runtime.Store))
		api.Post("/projects/{projectId}/members", handlers.UpsertProjectMember(runtime.Store))
		api.Delete("/projects/{projectId}/members/{userId}", handlers.DeleteProjectMember(runtime.Store))
		...
		api.Patch("/projects/{projectId}/members/{userId}/permissions", handlers.SetProjectMemberPermissions(runtime.Store))
		api.Delete("/projects/{projectId}/members/{userId}/permissions", handlers.DeleteProjectMemberPermission(runtime.Store))
		api.Patch("/projects/{projectId}/members/{userId}/document-rules", handlers.SetProjectMemberDocumentRules(runtime.Store))
		api.Delete("/projects/{projectId}/members/{userId}/document-rules", handlers.DeleteProjectMemberDocumentRule(runtime.Store))
		api.Get("/projects/{projectId}/tags", handlers.ListTags(runtime.Store))
		api.Post("/projects/{projectId}/tags", handlers.CreateTag(runtime.Store))
		api.Patch("/projects/{projectId}/tags/{tagId}", handlers.UpdateTag(runtime.Store))
		api.Get("/projects/{projectId}/documents", handlers.ListDocuments(runtime.Store))
		api.Post("/projects/{projectId}/documents", handlers.CreateDocument(runtime.Store))
		api.Get("/projects/{projectId}/documents/{documentId}", handlers.GetDocument(runtime.Store))
		api.Patch("/projects/{projectId}/documents/{documentId}", handlers.UpdateDocument(runtime.Store))
		api.Post("/projects/{projectId}/documents/{documentId}/tags", handlers.BindTagToDocument(runtime.Store))
		api.Delete("/projects/{projectId}/documents/{documentId}/tags/{tagId}", handlers.UnbindTagFromDocument(runtime.Store))
